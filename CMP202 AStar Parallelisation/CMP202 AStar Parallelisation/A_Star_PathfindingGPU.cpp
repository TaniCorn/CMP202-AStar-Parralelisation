...
bool Base_A_Star_PathfindingGPU::SetUpStartAndEndNodes(Vector2<int> startPos, Vector2<int> endPos)
{
	//Run Async functions to find node from positions
	std::future<Node*> startNode_fut = std::async(std::launch::async, &Base_A_Star_PathfindingGPU::GetNodeFromPosition,this, startPos);
	std::future<Node*> endNode_fut = std::async(std::launch::async, &Base_A_Star_PathfindingGPU::GetNodeFromPosition,this, endPos);
...
/// </summary>
Node* Base_A_Star_PathfindingGPU::GetNodeFromPosition(Vector2<int> position)
{
...
/// </summary>
Node* Base_A_Star_PathfindingGPU::FindNodeInRoom(Vector2<int> pos, Room* rm)
{
...
bool Base_A_Star_PathfindingGPU::IsNodeInRoom(const RoomStruct& nm, const Vector2<int> position)
{
...
void Base_A_Star_PathfindingGPU::EditNode(Vector2<int> nodePos, NodeType changeTo)
{
	//Get the node
...
void Base_A_Star_PathfindingGPU::PrintRoute()
{
...
void Base_A_Star_PathfindingGPU::ResetRoute()
{
...
/// </summary>
bool A_Star_Pathfinding_Defined_SegmentedGPU::AStarAlgorithm()
{
...
std::queue<Node*> A_Star_Pathfinding_Defined_SegmentedGPU::FindRouteNodePaths(std::stack<RoomStruct*> mapRoute)
{
...
std::stack<RoomStruct*> A_Star_Pathfinding_Defined_SegmentedGPU::BruteForcePathfindMaps()
{
...
Node* A_Star_Pathfinding_Defined_SegmentedGPU::FindRouteNode(std::stack<RoomStruct*>& mapRoute)
{
...
bool A_Star_Pathfinding_Defined_SegmentedGPU::MultiThreadedPathfinding(std::queue<Node*>* targetNodes)
{
...
/// <returns></returns>
bool A_Star_Pathfinding_Defined_SegmentedGPU::DefaultAStar(Node* startNode, Node* endNode)
{
...
void A_Star_Pathfinding_Defined_SegmentedGPU::CheckNeighbours(Node* current, Node* targetNode, std::set<Node*, ReverseComparator>* open, std::set<Node*>* closed)
{
