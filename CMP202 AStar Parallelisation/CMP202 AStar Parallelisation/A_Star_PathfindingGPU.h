...
#ifndef A_STAR_PATHFINDINGGPU_H
#define A_STAR_PATHFINDINGGPU_H
...
/// </summary>
class Base_A_Star_PathfindingGPU {
public:
...
/// </summary>
class A_Star_Pathfinding_Defined_SegmentedGPU : public Base_A_Star_PathfindingGPU {
public:
	A_Star_Pathfinding_Defined_SegmentedGPU() {};
	~A_Star_Pathfinding_Defined_SegmentedGPU() {
	};
